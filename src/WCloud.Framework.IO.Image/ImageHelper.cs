...
namespace WCloud.Framework.IO.Image_
{
    ...
    public static class ImageHelper
    {
        ...
        {
            buffer.Should().NotBeNullOrEmpty("bytes is null");
        ...
        public static Bitmap ImgFromBase64(string Imgb64)
        {
            var bs = ConvertHelper.Base64ToBytes(Imgb64);
            return BytesToBitmap(bs);
        }
        ...
        public static bool IsPixelFormatIndexed(Image img)
        {
            ...
            var indexedPixelFormats = new PixelFormat[]
            {
