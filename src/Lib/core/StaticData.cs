        ...
        public static class MimeTypes
        {
            public static string GetMimeType(string extension)
            {
                ...
                return _mappings
                    ...
                    .Where(x => x.Key.ToLower() == extension.ToLower())
                    .FirstOrDefault()?.Value ?? "application/octet-stream";
            }
            ...
            private static readonly IReadOnlyDictionary<string, string> _mappings =
