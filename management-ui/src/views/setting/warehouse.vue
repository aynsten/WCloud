    ...
    <a-modal title="标签" size="small" :width="800" v-model="x_form.show">
      <a-form>
        ...
        <a-form-item label="地址">
          <a-textarea v-model="x_form.data.Address" />
        </a-form-item>
      </a-form>
...
export default {
  ...
  methods: {
    query_all() {
      ...
      post_form(this, '/api/erp/admin/WareHouse/QueryAll', {})
        .then(res => {
          if (res.Success) {
    ...
    delete_(data) {
      ...
      post_form(this, '/api/erp/admin/WareHouse/Delete', {
        uid: data.UID
      })
        .then(res => {
          if (res.Success) {
    ...
    save_() {
      ...
      post_form(this, '/api/erp/admin/WareHouse/Save', {
