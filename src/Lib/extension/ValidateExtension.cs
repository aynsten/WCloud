...
namespace Lib.extension
{
    ...
    public static class ValidateExtension
    {
        ...
        public static bool IsAllPlumpString(this IEnumerable<string> arr) =>
            ValidateHelper.IsAllNotEmpty(arr.ToArray());
        ...
        /// <returns></returns>
        public static bool IsValid<T>(this T model, out string err) where T : class, IDBTable
        {
            err = model.GetValidErrors().FirstOrDefault();
            return ValidateHelper.IsEmpty(err);
        }
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public static List<string> GetValidErrors<T>(this T model) where T : class, IDBTable
        ...
        {
            return ValidateHelper.IsMailAddress(s);
        }
        /// <summary>
        /// 是否是电话
        /// </summary>
