<template>
  <div>
    <div v-if="order.data.OrderDeploymentDown">
      <div v-for="(item,i) in order.data.OrderDeploymentDown" :key="i">
        <p>
...
export default {
  ...
  methods: {
    ...
    save_deploy_image() {
      ...
      post_form(this, '/api/metro-ad/admin/MetroOrder/AddOrderDeploymentDown', {
