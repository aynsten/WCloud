...
namespace WCloud.Framework.IO
{
    ...
    public class ZipHelper
    {
        ...
        public void Zip(string outputFile, string fileOrDirectory)
        {
        ...
        public void Zip(string outputFile, string baseDirectory, IEnumerable<string> filesOrDirectories)
        {
        ...
        public void Zip(string outputFile, string baseDirectory, IEnumerable<string> filesOrDirectories, IEnumerable<string> ignoreFilesOrDirectories)
        {
        ...
        /// <param name="fileOrDirectory">文件或文件夹</param>
        public void Zip(Stream output, string fileOrDirectory)
        {
        ...
        /// <param name="baseDirectory">基目录</param>
        /// <param name="filesOrDirectories">文件或文件夹列表</param>
        public void Zip(Stream output, string baseDirectory, IEnumerable<string> filesOrDirectories)
        {
        ...
        /// <param name="filesOrDirectories">文件或文件夹列表</param>
        /// <param name="ignoreFilesOrDirectories">过滤的文件或文件夹列表</param>
        public void Zip(Stream output, string baseDirectory, IEnumerable<string> filesOrDirectories, IEnumerable<string> ignoreFilesOrDirectories)
        {
        ...
        public IList<string> Dezip(string inputFile, string outputDirectory)
        {
        ...
        /// <param name="inputFile">输入文档</param>
        public IList<string> GetFileList(string inputFile)
        {
            using (var input = new FileStream(inputFile, FileMode.Open, FileAccess.Read))
            {
